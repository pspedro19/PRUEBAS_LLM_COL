...
export async function POST(
  ...
  try {
    ...
    const response = await fetch(`${backendUrl}/api/icfes/feedback/${feedbackSessionId}/question/${questionId}/more/`, {
      method: 'POST',
      headers: {
    ...
    console.error('Error in progressive feedback more route:', error);
    return NextResponse.json(
