...
SAMPLE_QUESTIONS = [
    # MATEMÁTICAS - ÁLGEBRA BÁSICA ICFES (8 preguntas reales)
    {
        "title": "Ecuación lineal básica",
        "content": "Si 2x - 3 = 7, entonces el valor de x es:",
        "option_a": "2",
        "option_b": "5",
        "option_c": "4",
        "option_d": "10",
        "correct_answer": "B",
        "explanation": "2x - 3 = 7 → 2x = 7 + 3 → 2x = 10 → x = 5",
        "area": "matematicas",
    ...
    {
        "title": "Sistema de ecuaciones simples",
        "content": "En un teatro hay 240 asientos distribuidos en 12 filas. Si todas las filas tienen el mismo número de asientos, ¿cuántos asientos hay por fila?",
        "option_a": "18",
        "option_b": "20",
        "option_c": "22",
        "option_d": "24",
        "correct_answer": "B",
        "explanation": "Dividimos el total de asientos entre el número de filas: 240 ÷ 12 = 20 asientos por fila",
        "area": "matematicas",
        "topic": "Álgebra Básica",
        "subtopic": "Problemas de aplicación",
        "difficulty": "principiante",
        "points_value": 12
    },
    {
        "title": "Factorización básica",
        "content": "La expresión x² - 9 es equivalente a:",
        "option_a": "(x - 3)(x - 3)",
        "option_b": "(x + 3)(x + 3)",
        "option_c": "(x - 3)(x + 3)",
        "option_d": "x(x - 9)",
        "correct_answer": "C",
        "explanation": "x² - 9 es una diferencia de cuadrados: a² - b² = (a-b)(a+b), entonces x² - 3² = (x-3)(x+3)",
        "area": "matematicas",
        "topic": "Álgebra Básica",
    ...
    },
    {
        ...
        "content": "Si 5 cuadernos cuestan $15.000, ¿cuánto costarán 8 cuadernos del mismo tipo?",
        "option_a": "$18.000",
        "option_b": "$20.000",
        "option_c": "$24.000",
        "option_d": "$25.000",
        "correct_answer": "C",
        "explanation": "Cada cuaderno cuesta $15.000 ÷ 5 = $3.000. Entonces 8 cuadernos cuestan 8 × $3.000 = $24.000",
        "area": "matematicas",
        "topic": "Álgebra Básica",
        "subtopic": "Proporciones",
        "difficulty": "principiante",
        "points_value": 14
    },
    {
        "title": "Desigualdades lineales",
        "content": "¿Cuál de los siguientes valores de x satisface la desigualdad 2x + 1 > 9?",
        "option_a": "x = 3",
        "option_b": "x = 4",
        "option_c": "x = 5",
        "option_d": "x = 2",
        "correct_answer": "C",
        "explanation": "2x + 1 > 9 → 2x > 8 → x > 4. Solo x = 5 satisface esta condición",
        "area": "matematicas",
        "topic": "Álgebra Básica",
    ...
    {
        "title": "Gráfica de función lineal",
        "content": "IMAGEN: Una gráfica muestra una línea recta que pasa por los puntos (0, 2) y (4, 6). ¿Cuál es la ecuación de esta recta?",
        "option_a": "y = x + 2",
        "option_b": "y = 2x + 2",
        "option_c": "y = x + 4",
        "option_d": "y = 4x + 2",
        "correct_answer": "A",
        "explanation": "La pendiente es m = (6-2)/(4-0) = 4/4 = 1. La intersección con y es 2. Por tanto: y = x + 2",
        "area": "matematicas",
        "topic": "Álgebra Básica",
        "subtopic": "Funciones lineales",
        "difficulty": "principiante",
        "points_value": 20
    },
    {
        "title": "Expresiones algebraicas",
        "content": "Si a = 3 y b = -2, el valor de la expresión 2a - 3b + 1 es:",
        "option_a": "11",
        "option_b": "13",
        "option_c": "9",
        "option_d": "7",
        "correct_answer": "B",
        "explanation": "Sustituyendo: 2(3) - 3(-2) + 1 = 6 + 6 + 1 = 13",
        "area": "matematicas",
        "topic": "Álgebra Básica",
        "subtopic": "Evaluación de expresiones",
        "difficulty": "principiante",
        "points_value": 12
    },
    {
        "title": "Ecuación cuadrática simple",
        "content": "La ecuación x² = 16 tiene como soluciones:",
        "option_a": "x = 4 únicamente",
        "option_b": "x = 4 y x = -4",
        "option_c": "x = 8 únicamente",
        "option_d": "x = 2 y x = -2",
        "correct_answer": "B",
        "explanation": "x² = 16 implica x = ±√16 = ±4, por tanto x = 4 o x = -4",
        "area": "matematicas",
        "topic": "Álgebra Básica",
